...
const DoctorManagement = () => {
  ...
  // Lấy tên chuyên khoa từ specialityId
  const getSpecialityName = (specialityId) => {
    if (!specialityId) return 'Chưa cập nhật';
    const speciality = specialities.find(spec => spec.specialityId === specialityId);
    return speciality ? speciality.name : 'Chưa cập nhật';
  };

  // Filter doctors based on search and filters
  const filteredDoctors = doctors.filter(doctor => {
    const specialityName = getSpecialityName(doctor.specialityId);
